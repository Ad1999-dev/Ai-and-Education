...
   P(a|aa) = $\frac{2}{6}$
   
    P(X_1=a, X_2=a, X_3=a) = $\frac{11}{20} \cdot \frac{6}{11} \cdot \frac{2}{6} = \frac{11 \cdot 6 \cdot 2}{20 \cdot 11 \cdot 6} = \frac{132}{1320} = \frac{1}{10} = 0.1$
...
   P(b|aa) = $\frac{2}{6}$
   
    P(X_1=a, X_2=a, X_3=b) = $\frac{11}{20} \cdot \frac{6}{11} \cdot \frac{2}{6} = \frac{11 \cdot 6 \cdot 2}{20 \cdot 11 \cdot 6} = \frac{132}{1320} = \frac{1}{10} = 0.1$
...
   P(c|aa) = $\frac{2}{6}$
   
    P(X_1=a, X_2=a, X_3=c) = $\frac{11}{20} \cdot \frac{6}{11} \cdot \frac{2}{6} = \frac{11 \cdot 6 \cdot 2}{20 \cdot 11 \cdot 6} = \frac{132}{1320} = \frac{1}{10} = 0.1$
...
This function selects which character in the sequence has the best chance of appearing next in order to predict the next character. It uses calculate_probability to determine each character's probability and selects the one with the highest value.
...
- **Based on the probability distribution obtained above for all the next possible characters, which character would be next in the sequence?**
  - 'a' would be the most likely next character as it is first in the list and all 3 letters have equal probability of 1/10
...
I tested both files, and discovered that "War and Peace" perform better "Alice's Adventures in Wonderland" in character prediction tasks. 

In terms of figuring how high the n value can be, I experiment the n value from 1 to 5 and after experimenting, I found that n = 3 or 4 is the best between performance and prediction quality.  For instance, using n = 4 and the input "Alic" produced predictions such as "Alice," "Alice t," and "Alice the" that closely matched the actual text. For higher value than 5, there was poor generalization was demonstrated by the overfit, incorrect prediction like "Alicss" or "Alic111" instead of "Alice". 
