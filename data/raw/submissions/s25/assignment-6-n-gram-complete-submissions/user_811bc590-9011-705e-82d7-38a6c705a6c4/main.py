from utilities import read_file, print_table, output_table
...
def main():
    ...
    #output_table(tables, 2, output_file)
    # print("PROB", calculate_probability('bc', 'd', tables))
