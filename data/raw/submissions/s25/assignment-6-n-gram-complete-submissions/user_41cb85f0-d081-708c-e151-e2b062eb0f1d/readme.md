...
First, I create n tables to store frequences for all n grams. Loop from 1 to n to go through the side of the n-gram to build. For each value of k, look through the document to find every possible substring that is k characters long. Finally, we update the frequency count of the current ngram and return the frequency table.  
...
- ***Put the intuition of your code here***
Base case of k==0, estimating how likely the character appears on its own by dividing the number of times char shows up in the text by the total amount of characters. Then, if the length of sequence is greater than the length of the tables, then return 0 because that's not possible. Then, return the frequency by dividing the number of times the full string is formed by the total number of times the prefix appears by itself in the table. 
...
1. $P(X_1=a, X_2=a, X_3=a)$
   ...
   $P(a) = \frac{11}{20}, \quad P(a \mid a) = \frac{1}{2}, \quad P(a \mid aa) = \frac{1}{4}$
   $P(a, a, a) = \frac{11}{20} \cdot \frac{1}{2} \cdot \frac{1}{4} = \frac{11}{160}$
   
   
2. $P(X_1=a, X_2=a, X_3=b)$
   - *Show your work*
   $P(a, a, b) = P(a) \cdot P(a \mid a) \cdot P(b \mid aa)$
   $P(a) = \frac{11}{20}, \quad P(a \mid a) = \frac{1}{2}, \quad P(b \mid aa) = \frac{2}{4}$
   $P(a, a, b) = \frac{11}{20} \cdot \frac{1}{2} \cdot \frac{2}{4} = \frac{11}{80}$
3. $P(X_1=a, X_2=a, X_3=c)$
   - *Show your work* 
   $P(a, a, c) = P(a) \cdot P(a \mid a) \cdot P(c \mid aa)$
   $P(a) = \frac{11}{20}, \quad P(a \mid a) = \frac{1}{2}, \quad P(c \mid aa) = \frac{1}{4}$
   $P(a, a, c) = \frac{11}{20} \cdot \frac{1}{2} \cdot \frac{1}{4} = \frac{11}{160}$
...
- ***Put the intuition of your code here***
Try each character as the next possible character, and we can call calculate_probability to help us in finding the probabiity that the character will come next and store it in k. If k is better than our current probability, then update bestChar to i or if it's the same probability i decided to choose the smaller character using ASCII. Finally, after we looped through all the characters, return the one with the highest probability. 
...
I've noticed that shorter corpus work better than others as Alice in Wonderland worked better than War and Peace and it was significantly shorter. 

Alice in Wonderland had a better performance with smaller values of n, and end up until n = 19, came out with values almost instantly. At n = 53, it was the first time it had took over a second and at n = 91, it took over 3 seconds. I tested up until n=100, and while it did take progressively longer for the calculations as n gets larger, it doesn't really reach a point where it's too time consuming although some could argue that 3 seconds is too long for a calculation. 

War and peace also had a better performance with smaller values of n, and bypassed 3 seconds at n = 6. At n =  10, it took longer than 11 seconds to calculate which i would argue is too time consuming. 
