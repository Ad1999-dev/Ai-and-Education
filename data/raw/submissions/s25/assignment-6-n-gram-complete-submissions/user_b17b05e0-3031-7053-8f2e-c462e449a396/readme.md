...
- ***Constructs `n` frequency tables. Table `k` (index `k-1`) tracks counts of all `k`-length character sequences in the document.***
...
- $P(c \mid s_1, \dots, s_k) = \frac{\text{count}(s_1, \dots, s_k, c)}{\text{count}(s_1, \dots, s_k)}$

### Code analysis

- ***Computes the conditional probability of a character `char` appearing next after a sequence `sequence`.***
...
1. $P(X_1=a, X_2=a, X_3=a)$
   - *Show your work*
   - $P(a) \cdot P(a \mid a) \cdot P(a \mid aa) = \frac{11}{20} \cdot \frac{3}{9} \cdot \frac{1}{3}= 0.55 \cdot 0.333 \cdot 0.333 \approx \boxed{0.061}$

2. $P(X_1=a, X_2=a, X_3=b)$
   - *Show your work*
   - $P(a) \cdot P(a \mid a) \cdot P(b \mid aa) = \frac{11}{20} \cdot \frac{3}{9} \cdot 0 = \boxed{0}$


3. $P(X_1=a, X_2=a, X_3=c)$
   - *Show your work* 
   - $P(a) \cdot P(a \mid a) \cdot P(c \mid aa) = \frac{11}{20} \cdot \frac{3}{9} \cdot \frac{2}{3} = 0.55 \cdot 0.333 \cdot 0.667 \approx \boxed{0.122}$
...
- ***Predicts the most probable next character given a sequence by choosing the one with the highest probability.***
