...
$$P(X_1=x_1, X_2=x_2, X_3=x_3,...X_N=x_n) = \frac{f(x_1)}{size(C)} \cdot \frac{f(x_1,x_2)}{f(x_1)} \cdot \frac{f(x_1x_2,x_3)}{f(x_2,x_1)} \cdot \frac{f(x_1,x_2,x_3,...x_n)}{f(x_1,x_2,x_3,...x_(n - 1))}$$
...
- I store the frequency of same length substrings in a dictionary in a list.
...
- ***Put the intuition of your code here***
- If the vocabulary is empty, I return 0. If the sequence is empty, I return 1 since the probability is vacously 1. If the length of the sequence with the character is greater than n, then I only look at the last n characters. If the sequence and character are not in the table, then I return 0. Otherwise I calculate the probability using the formula above.
...
1. $P(X_1=a, X_2=a, X_3=a)$
   - *Show your work*
   - $P(X_1=a) \cdot \frac{P(X_1=a, X_2=a)}{P(X_1=a)} \cdot \frac{P(X_1=a, X_2=a, X_3=a)}{P(X_1=a, X_2=a)}$
   - $11/20 \cdot 1/2 \cdot 1/4$
   - 11/160
2. $P(X_1=a, X_2=a, X_3=b)$
   - *Show your work*
   - $P(X_1=a) \cdot \frac{P(X_1=a, X_2=a)}{P(X_1=a)} \cdot \frac{P(X_1=a, X_2=a, X_3=b)}{P(X_1=a, X_2=a)}$
   - $11/20 \cdot 1/2 \cdot 1/2$
   - 11/80
3. $P(X_1=a, X_2=a, X_3=c)$
   - *Show your work*
   - $P(X_1=a) \cdot \frac{P(X_1=a, X_2=a)}{P(X_1=a)} \cdot \frac{P(X_1=a, X_2=a, X_3=c)}{P(X_1=a, X_2=a)}$
   - $11/20 \cdot 1/2 \cdot 1/4$
   - 11/160
...
- ***Put the intuition of your code here***
- I loop through the vocabulary to return the most probable next character.
...
- During the experiment with the corpus files "Alice's Adventures in Wonderland" and "War and Peace," several insights emerged regarding n-gram analysis. The shorter and whimsical nature of Alice's narrative resulted in a higher density of meaningful bigrams and trigrams compared to the more verbose and complex structure of War and Peace. For n = 1 (unigrams), both corpuses provided a large variety of unique words, while unique n-grams started to stabilize and become less informative as `n` increased beyond 4. Specifically, computational costs efficiently scaled up to `n = 3` or `n = 4`, after which the processing time significantly increased, notably surpassing 5 seconds for `n = 5` with larger datasets. This experiment indicated that while both texts yield useful n-grams, n = 3 or 4 provides a balance between meaningful insights and computational efficiency.
