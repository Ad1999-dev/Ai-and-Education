...
## Dataset 1: Repeated Alphabet Sequence

![Output for abcdefghijklmnopqrstuvwxyz](abc.png)

| Dataset           | Final Train Loss | Final Test Loss | Test Accuracy |
|-------------------|------------------|------------------|---------------|
| Alphabet Sequence  | 0.0557           | 0.0213           | 100.00%       |

### Model Performance 

- At low temperatures (e.g., 0.3), the model produced highly deterministic completions, continuing the alphabetical sequence perfectly (as shown in the attached screenshot).

- At high temperatures (e.g., 4), there was a lot of randomness in these completions, which included skips and repetitions.


### Model Inference

This demonstrates that the temperature parameter affects the predictability of the generated output while still maintaining the learned pattern structure.

## Dataset 2: War and Peace

![Output for warandpeace.txt](warandpeace.png)

| Dataset           | Final Train Loss | Final Test Loss | Test Accuracy |
|-------------------|------------------|------------------|---------------|
| War and Peace     | 1.6338           | 1.6197           | 52.61%        |
