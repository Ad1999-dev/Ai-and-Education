...
To make $n$ tables, I looped over $n$ using a loop variable $i$ and for each $i$, I would loop over the entire document and consider every --gram in the document and add it to the ith dictionary in my list tables. 
...
- $P(X_1=x_1,X_2=x_2,X_3=x_3)=P(X_1=x_1)P(X_2=x_2 | X_1=x_1)P(X_3=x_3|X_1=x_1,X_2=x_2)$

### Code analysis

- I split this function up into three cases 1) calculating the probability for the first character 2) calculating the probability of letters before we reach n letters 3) calculating the probability once n or more letters have been processed. 
...
1. $P(X_1=a, X_2=a, X_3=a)$
   - $P(X_1=a, X_2=a, X_3=a) = P(X_1=a)P(X_2=a|X_1=a)P(X_3=a|X_1=a,X_2=a)=\frac{11}{20}\cdot0.45\cdot0.5=0.12$
2. $P(X_1=a, X_2=a, X_3=b)$
   - $P(X_1=a, X_2=a, X_3=b) = P(X_1=a)P(X_2=a|X_1=a)P(X_3=b|X_1=a,X_2=a)=\frac{11}{20}\cdot0.45\cdot0.27=0.07$
3. $P(X_1=a, X_2=a, X_3=c)$
   - $P(X_1=a, X_2=a, X_3=c)=P(X_1=a)P(X_2=a|X_1=a)P(X_3=c|X_1=a,X_2=a)=\frac{11}{20}\cdot0.45\cdot0.19=0.05$
...
- I looped over the letters in the vocabulary, and I calculated $P(sequence+v)$ and $P(sequence)$ to calculate the probability of $P(v | sequence)$, storing the probabilites in a dictionary for each character. Then I return the character with the highest probability from the dictionary. 
...
I can run until about n=8 until the table calculation becomes too time consuming with warandpeace.txt, and higher for Alice in Wonderland with n=20. Because of this, it seems like Alice in Wonderland is a better corpus file than War and Peace. 
<hr>
