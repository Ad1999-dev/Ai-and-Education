...
class CharRNN(nn.Module):
    ...
    def forward(self, x, hidden):
        ...
        logits = self.W_ho(output) # [b, l, vocab_size=v] 
...
num_epochs = 6        # Number of epochs to train
...
def generate_text(model, start_text, n, k, temperature=1.0):
    ...
    with torch.no_grad():
        for i in range (k):
            ...
            sampled_idx = sample_from_output(last_logits, temperature=temperature)
            next_char_idx = sampled_idx.item()
